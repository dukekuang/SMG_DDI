...
parser.add_argument('--dataset', type=str, default='ZhangDDI', choices=['ZhangDDI','ChChMiner','DeepDDI'])
parser.add_argument('--train_data_path', type=str, default='datachem/randomsplit/ZhangDDI_train.csv')
parser.add_argument('--valid_data_path', type=str, default='datachem/randomsplit/ZhangDDI_valid.csv')
parser.add_argument('--test_data_path', type=str, default='datachem/randomsplit/ZhangDDI_test.csv')
parser.add_argument('--train_output_path', type=str, default='datachem/scaffoldsplit/ZhangDDI_train_scaffold_0.csv')
parser.add_argument('--val_output_path', type=str, default='datachem/scaffoldsplit/ZhangDDI_valid_scaffold_0.csv')
parser.add_argument('--test_output_path', type=str, default='datachem/ZhangDDI_test_scaffold.csv')
...
if args.dataset == 'DeepDDI':
	...
	with open(data_train_path, 'r') as f:
		...
		while True:
			...
			smile1 = line_list[0]; smile2 = line_list[1]
			inter_relation = line_list[2]
			
			smiles_set.add(smile1); smiles_set.add(smile2)
	...
	train, val, test = scaffold_split(dataset, sizes=(0.8, 0.1, 0.1), seed=args.seed)
...
if args.dataset == 'ChChMiner':
	...
	with open(data_train_path, 'r') as f:
		...
		while True:
			...
			line_list = line.split(',')
			drug1 = line_list[0]; drug2 = line_list[1]
			smile1 = line_list[2]; smile2 = line_list[3]
			inter_relation = line_list[4]
			
			drug2smile[drug1] = smile1; drug2smile[drug2] = smile2
			smile2drug[smile1] = drug1; smile2drug[smile2] = drug2
...
if args.dataset == 'ZhangDDI':
	...
	with open(data_train_path, 'r') as f:
		...
		while True:
			...
			drug1 = line_list[0]; drug2 = line_list[1]
			smile1 = line_list[3]; smile2 = line_list[2]
			cid1 = line_list[4]; cid2 = line_list[5]
			inter_relation = line_list[6]
			
			drug2smile[drug1] = smile1; drug2smile[drug2] = smile2
			smile2drug[smile1] = drug1; smile2drug[smile2] = drug2
			drug2cid[drug1] = cid1; drug2cid[drug2] = cid2
			smiles_set.add(smile1); smiles_set.add(smile2)
