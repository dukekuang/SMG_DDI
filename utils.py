...
from models import build_model, MoleculeModel
...
def save_checkpoint(path: str,
    ...
    state = {
        ...
        'features_scaler': {'means': features_scaler.means, 'stds': features_scaler.stds} if features_scaler is not None else None
    }
...
def load_checkpoint(path: str,
    ...
    # Build model
    model = build_model(args, ddi=ddi)
    ...
    for param_name in loaded_state_dict.keys():
        ...
        if param_name not in model_state_dict:
            ...
            logger.info(f'Loading pretrained parameter "{param_name}".')
